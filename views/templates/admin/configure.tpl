...
<div class="col-lg-2">
    ...
    <a href="#recurring-payment-configuration" class="list-group-item {if $payline_active_tab == 'recurring-web-payment'}selected_tab active{/if}" data-toggle="tab" data-identifier="recurring-payment-configuration"><i class="icon icon-cogs"></i>&nbsp;&nbsp;{l s='Recurring payment' mod='payline'}</a>
